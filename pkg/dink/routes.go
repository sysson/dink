...
import (
	...
	"github.com/sysson/dink/pkg/server/router/plugin"
	"github.com/sysson/dink/pkg/server/router/session"
	"github.com/sysson/dink/pkg/server/router/swarm"
	"github.com/sysson/dink/pkg/server/router/system"
	"github.com/sysson/dink/pkg/server/router/volume"
